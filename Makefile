...
gemm.o: linear-algebra/blas/gemm/gemm.c linear-algebra/blas/gemm/gemm.h
	$(CC) $(CFLAGS) $(PB_FLAGS) -c -I utilities -I linear-algebra/blas/gemm linear-algebra/blas/gemm/gemm.c -o $@
...
gemm: polybench.o gemm.o
	$(CC) $(CFLAGS) gemm.o polybench.o -o gemm
